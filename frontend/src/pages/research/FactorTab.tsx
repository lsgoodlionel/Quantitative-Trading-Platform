// 因子研究 Tab（原 /factor 整页）：预设/公式因子分析 + 因子库、流水线、挖掘、实验、策略。
// 由 pages/FactorAnalysis.tsx 迁入研究页的一个 Tab（V3 · H1），逻辑未改。
...
import {
  CumulativeIcChart, FactorSeriesChart, IcSeriesChart, IcStatsTable,
  PERIOD_COLORS, QuantileChart,
} from "./FactorCharts"
                ...
                return (
                  <div className="card border-[#30363d] space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <Link to="/portfolio?tab=optimizer"
