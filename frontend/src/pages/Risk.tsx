        ...
        <div className="space-y-4">
          ...
          {summary && (summary.violations?.length ?? 0) > 0 && (
            <div className="rounded-lg border border-[#f85149]/20 bg-[#1a0f0f] p-3 space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Link to="/trading?tab=orders" className="px-3 py-1.5 rounded text-xs border border-[#e3b341]/30 text-[#e3b341] hover:bg-[#e3b341]/10 transition-colors">
                  📋 前往下单减仓
                </Link>
                <Link to="/trading?tab=live" className="px-3 py-1.5 rounded text-xs border border-[#6e7681]/30 text-[#8b949e] hover:bg-[#21262d] transition-colors">
                  ⏸ 暂停运行策略
                </Link>
              </div>
            </div>
          ...
          <div className="rounded-lg border border-[#30363d] bg-[#161b22] p-3 space-y-2">
            ...
            <div className="space-y-1.5 text-[10px] text-[#6e7681]">
              <p>▸ VaR 过高（风险偏大）→ <Link to="/portfolio?tab=optimizer" className="text-[#58a6ff] hover:underline">组合优化</Link> 重新分配权重，降低集中度</p>
              <p>▸ 波动率持续偏高 → <Link to="/research?tab=ml" className="text-[#58a6ff] hover:underline">算法实验室 · GARCH</Link> 建立动态止损模型</p>
              <p>▸ 回撤超限 → <Link to="/trading?tab=orders" className="text-[#58a6ff] hover:underline">订单中心</Link> 手动减仓，或 <Link to="/trading?tab=live" className="text-[#58a6ff] hover:underline">停止运行策略</Link></p>
